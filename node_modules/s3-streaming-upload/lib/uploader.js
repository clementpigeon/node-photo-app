        ...
        return checkPartsInterval = setInterval((function() {
          ...
          return _this.getNewClient().listParts({
            ...
            if (checkPartsCounterInt > _this.waitForPartAttempts) {
              if (!callbackCalled) {
                callbackCalled = true;
                console.warn("Not all parts uploaded. Uploaded: " + (JSON.stringify(_this.uploadedParts)) + ", Reported by listParts as uploaded: " + (JSON.stringify(data != null ? data['Parts'] : void 0)) + " after " + _this.waitForPartAttempts + " atempts");
                return cb();
              }
            }
          });
